...
if (!source.includes("canonical-sanity-schoolv2")) {
  source = source.replace(
    '"use client";',
    '"use client";\n\n// canonical-sanity-schoolv2: live portal is pinned to u5d5zn7n/schoolv2.',
  );
}
...
for (const marker of [
  ...
  if (!source.includes(marker)) throw new Error(`Pinned portal is missing ${marker}`);
}

writeFileSync(path, source);
console.log("Pinned the generated portal and data contract to the canonical live Sanity dataset.");
