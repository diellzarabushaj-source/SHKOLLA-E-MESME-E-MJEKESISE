    ...
    defineField({
      ...
      options: {
        ...
        list: [
          ...
          {title: 'Kristalet - format karakteristike', value: 'crystalForms'},
          {title: 'Kristalet - rrjeti dhe celula elementare', value: 'crystalLattice'},
          {title: 'Kristalet - anizotropia', value: 'crystalAnisotropy'},
        ],
      },
