...
export default function LessonLearningExperience({
  ...
  useEffect(() => {
    ...
    setReadingProgress(clamp(typeof saved.readingProgress === "number" ? saved.readingProgress : 0));
    setActiveHeading("");
    setLastHeading(typeof saved.lastHeading === "string" ? saved.lastHeading : "");
    setStoredSignature(typeof saved.signature === "string" ? saved.signature : "");
  ...
  useEffect(() => {
    ...
    setLastHeading((current) => validIds.has(current) ? current : "");
  ...
  }, [completed, contentSignature, headingsReady, lastHeading, loadedStorageKey, readingProgress, storageKey, storedSignature, visited]);
