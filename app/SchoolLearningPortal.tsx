    ...
    return (
      <main data-campus-view className="inner-page study-page">
        <div className={styles.hierarchy} data-campus-breadcrumb>
          ...
          <button type="button" onClick={goToChapter}>{selectedChapter.title}</button><span>/</span>
        ...
        {!card ? (
          <div className="empty-state large">
            ...
            <button type="button" className="secondary-button" onClick={exitStudy}>Kthehu</button>
          </div>
        ) : finished ? (
          <section className="finish-card">
            ...
            <div className="finish-actions">
              <button type="button" className="secondary-button" onClick={exitStudy}>Kthehu</button>
              <button type="button" className="secondary-button" onClick={() => restartDeck(true)}>Përzieje</button>
              <button type="button" className="primary-button" onClick={() => restartDeck(false)}>Rifillo</button>
            </div>
          </section>
        ) : (
          <section className="study-shell">
            <div className="study-toolbar">
              ...
              <div className="study-tools">
                <button type="button" className="icon-button" onClick={previousCard} disabled={cardIndex === 0} aria-label="Kartela paraprake">←</button>
                <button type="button" className="ghost-button" onClick={() => restartDeck(true)}>Përziej</button>
              </div>
            </div>
            ...
            {!revealed ? (
              ...
              <div className="rating-actions" aria-label="Vlerëso kartelën">
                <button type="button" className="rating-again" onClick={() => rateCard("again")}><b>Përsëri</b><span>&lt; 1 min</span><kbd>1</kbd></button>
                <button type="button" className="rating-hard" onClick={() => rateCard("hard")}><b>Vështirë</b><span>6 min</span><kbd>2</kbd></button>
                <button type="button" className="rating-good" onClick={() => rateCard("good")}><b>Mirë</b><span>10 min</span><kbd>3</kbd></button>
                <button type="button" className="rating-easy" onClick={() => rateCard("easy")}><b>Lehtë</b><span>4 ditë</span><kbd>4</kbd></button>
              </div>
            )}
              ...
              <div className={styles.lessonList}>
                {selectedChapter.lessons.map((lesson, index) => (
                  <article data-campus-lesson className={styles.lessonRow} key={lesson._id}>
                    ...
                    <button type="button" className={styles.lessonOpen} onClick={() => chooseLesson(lesson)}>Hape mësimin</button>
                  </article>
                ))}
              </div>
            ) : (
        ...
        <section className={styles.portalHero} data-campus-grade-hero>
          <div>
            ...
            <div className={styles.portalActions}>
              <button type="button" className={styles.secondaryAction} onClick={changeGrade}>Ndrysho klasën</button>
              <button type="button" className={styles.primaryAction} onClick={() => document.getElementById("lendet")?.scrollIntoView({ behavior: "smooth" })}>Shiko lëndët</button>
            </div>
          </div>
